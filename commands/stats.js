        ...
        try {
            const statsEmbed = new EmbedBuilder()
                ...
                .addFields({ name: 'Bot Name', value: client.user.tag, inline: true },
                    ...
                    { name: 'Bot Creator', value: 'Itz_Toothless#8135', inline: true },
                    { name: 'Bot Created At', value: `**<t:${Math.round(parseInt(client.user.createdTimestamp) / 1000)}:F>**`, inline: true },
                    { name: 'Bot Uptime', value: `**<t:${Math.round(parseInt(client.readyTimestamp) / 1000)}:R>**`, inline: true })
                .setTimestamp()
